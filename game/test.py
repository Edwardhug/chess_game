...
bp = Piece('b', 'p', 'Pieces_png/pb.png')
wp = Piece('w', 'p', 'Pieces_png/pw.png')
bk = Piece('b', 'k', 'Pieces_png/kb.png')
wk = Piece('w', 'k', 'Pieces_png/kw.png')
br = Piece('b', 'r', 'Pieces_png/rb.png')
wr = Piece('w', 'r', 'Pieces_png/rw.png')
bb = Piece('b', 'b', 'Pieces_png/fb.png')
wb = Piece('w', 'b', 'Pieces_png/fw.png')
bq = Piece('b', 'q', 'Pieces_png/qb.png')
wq = Piece('w', 'q', 'Pieces_png/qw.png')
bkn = Piece('b', 'kn', 'Pieces_png/cb.png')
wkn = Piece('w', 'kn', 'Pieces_png/cw.png')
...
def create_board(board):
    board[0] = [Piece('b', 'r', 'Pieces_png/rb.png'), Piece('b', 'kn', 'Pieces_png/cb.png'), Piece('b', 'b', 'Pieces_png/fb.png'), \
               Piece('b', 'q', 'Pieces_png/pb.png'), Piece('b', 'k', 'Pieces_png/kb.png'), Piece('b', 'b', 'Pieces_png/fb.png'), \
               Piece('b', 'kn', 'Pieces_png/cb.png'), Piece('b', 'r', 'Pieces_png/rb.png')]

    board[7] = [Piece('w', 'r', 'Pieces_png/rw.png'), Piece('w', 'kn', 'Pieces_png/cw.png'), Piece('w', 'b', 'Pieces_png/fw.png'), \
               Piece('w', 'q', 'Pieces_png/qw.png'), Piece('w', 'k', 'Pieces_png/kw.png'), Piece('w', 'b', 'Pieces_png/fw.png'), \
               Piece('w', 'kn', 'Pieces_png/cw.png'), Piece('w', 'r', 'Pieces_png/rw.png')]
